...
async function seedViaSupabaseClient() {
  ...
  const epRows = [
    ...
    { show_slug: 'patriot-hour', slug: 'ep-207-federal-overreach', title: 'Ep. 207 — Federal Overreach', description: 'Constitutional lens on mandates.', audio_url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', video_url: null, mux_playback_id: null, thumbnail_url: STOCK.newsroomPolitics, chapters: null, host_name: 'Marcus Webb', duration_s: 3600, episode_no: 207, pub_date: new Date(Date.now() - 5*86400000).toISOString(), guid: 'seed:patriot-hour:ep-207' },
  ];
