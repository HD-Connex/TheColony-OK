          ...
          >
            {series.hero_url && (
              <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
                <Image src={series.hero_url} alt="" fill priority sizes="100vw" style={{ objectFit: "cover", opacity: 0.35 }} />
                <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, var(--background), transparent 70%)" }} />
              </div>
            )}
            {!series.hero_url && (
              <div
                          ...
                          <div className="episode-row__content">
                            <div style={{ display: "flex", gap: ".5rem", flexWrap: "wrap", alignItems: "center" }}>
                              {ep.episode_number != null && (
                                <span style={{ fontFamily: "var(--font-mono)", fontSize: ".7rem", color: "var(--muted-foreground)" }}>
