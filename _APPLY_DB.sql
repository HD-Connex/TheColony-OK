-- The Colony OK — full DB apply bundle (generated 2026-06-22)
-- Paste into Supabase SQL editor for project jwqgirmxoksxhevjnnwm.
-- Order: all migrations 0001..0031 (gaps 0002/0025/0027 are historical), then seed-content.sql.
-- Re-runnable: migrations use IF NOT EXISTS / idempotent guards; seed is idempotent (NOT EXISTS / ON CONFLICT).
