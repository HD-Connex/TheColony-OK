...
-- Note: Main expanded seed is now in ../supabase/seed-content.sql (includes 3 fully migrated newsletter archive articles as native stories). This is legacy partial. All Substack/external references removed.
